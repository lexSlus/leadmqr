...
@dataclass
class Settings:
    poll_interval_sec: int = int(os.getenv("TT_POLL_INTERVAL_SEC", "20"))  # как часто проверять лиды
    ...
    email: str = os.getenv("TT_EMAIL", "sloboda282@gmail.com")
    # email: str = os.getenv("TT_EMAIL", "wkononov@gmail.com")
    password: str = os.getenv("TT_PASSWORD", "P@ssw0rd+5")
