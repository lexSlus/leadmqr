...
log "Запуск VNC окружения для Monitor Service..."
...
log "VNC окружение готово! Откройте http://localhost:6081 в браузере"

cd /app

log "Запуск Monitor Service..."
exec python -m monitor_service.main
